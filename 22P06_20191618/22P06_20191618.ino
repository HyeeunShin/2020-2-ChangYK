...
#define _DIST_ALPHA 0.4   //[3054] 센서 보정정도
          // [3131] EMA필터값
// Servo range
#define _DUTY_MIN 1290  // [3052] 서보의 최소각도를 microseconds로 표현
#define _DUTY_NEU 1450  
// [3070] 레일플레이트 중립위치를 만드는 서보 duty값
#define _DUTY_MAX 1590                //[3062] 서보의 최대각도의 microseconds의 값
...
// PID parameters
#define _KP 1.4 // [2635] P 이득 비율(?)
#define _KI 0.0   // [2635] I 이득 비율
#define _KD 0.0 // [2635] D 이득 비율

// global variables
const float coE[] = {-0.0000053, 0.0034677, 0.2571168, 75.2426615};
//////////////////////
// global variables //
//////////////////////
