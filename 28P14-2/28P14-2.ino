...
// PID parameters
#define _KP 3.6 // [2635] P 이득 비율(?)
#define _KI 0.03   // [2635] I 이득 비율
#define _KD 38.0 // [2635] D 이득 비율
...
void loop() {
    ...
    if(event_dist) {
        ...
        dist_ema = (_DIST_ALPHA * dist_raw + (1 - _DIST_ALPHA) * dist_ema) + 17.50; 
