...
#define _DIST_MIN 0   //[3050] 거리의 최솟값이 100mm
...
#define _DIST_ALPHA 0.4  //[3054] 센서 보정정도
          // [3131] EMA필터값
// Servo range
#define _DUTY_MIN 1150  // [3052] 서보의 최소각도를 microseconds로 표현
#define _DUTY_NEU 1450  
// [3070] 레일플레이트 중립위치를 만드는 서보 duty값
#define _DUTY_MAX 1750                //[3062] 서보의 최대각도의 microseconds의 값

#define _ITERM_MAX 0.5

// Servo speed control
#define _SERVO_ANGLE 90   // [3131] 최대 가동범위에 따른 목표 서보 회전각
...
// PID parameters
#define _KP 4.0 // [2635] P 이득 비율(?)
#define _KI 0.3   // [2635] I 이득 비율
#define _KD 40.0 // [2635] D 이득 비율


// global variables
const float coE[] = {0.0000056, -0.0028780, 1.4029050, -18.4361770};
//////////////////////
// global variables //
//////////////////////
...
void loop() {
    ...
    if(event_dist) {
        ...
        dist_ema = (_DIST_ALPHA * dist_raw + (1 - _DIST_ALPHA) * dist_ema) + 18.411; 
